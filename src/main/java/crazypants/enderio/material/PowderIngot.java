...
public enum PowderIngot {
    ...
    POWDER_SILICON("powderSilicon", null, "dustSilicon"),
    POWDER_ELECTRICAL_STEEL("powderElectricalSteel", null, "dustElectricalSteel"),
    POWDER_DARK_STEEL("powderDarkSteel", null, "dustDarkSteel");
