...
public class ToolHelper {
    public static boolean isToolEffective(ItemStack stack, World world, int x, int y, int z) {
        ...
        return false;
            ...
            return isToolEffective(stack, block, world.getBlockMetadata(x, y, z))
    ...
    public static void harvestBlock(World world, int x, int y, int z, EntityPlayer entityPlayer) {
        ...
        if (!ForgeEventFactory.doPlayerHarvestCheck(
                player, block, isToolEffective(player.getCurrentEquippedItem(), world, x, y, z)))
            if (!player.capabilities.isCreativeMode) return;
    ...
    public static boolean hoeBlock(
            ItemStack stack, World world, int x, int y, int z, int sideHit, EntityPlayer player) {
        Block block = world.getBlock(x, y, z);
