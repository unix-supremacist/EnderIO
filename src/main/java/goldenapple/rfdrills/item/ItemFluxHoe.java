...
public class ItemFluxHoe extends ItemTool implements IEnergyTool {
    public static final Set<Material> effectiveMaterials =
            Sets.newHashSet(Material.leaves, Material.plants, Material.vine, Material.web);
    ...
    public String getUnlocalizedName() {
        return "item." + EnderIO.MODID.toLowerCase() + ":" + "flux_hoe";
    }
    ...
    public void registerIcons(IIconRegister iconRegister) {
        itemIcon = iconRegister.registerIcon(EnderIO.MODID.toLowerCase() + ":" + "flux_hoe");
    }
