...
public class UpgradeBeastMode extends AbstractSoulUpgrade {
    ...
    public boolean isRecipeValid(int level, ItemStack itemStack) {
        switch (level) {
            case 1:
                return itemStack.getItem() == ModItems.componentEIO
                        && itemStack.getItemDamage() == Metadata.DESTRUCTIVE_CRYSTAL;
            case 2:
                return itemStack.getItem() == ModItems.componentEIO
                        && itemStack.getItemDamage() == Metadata.EARTHSHAKING_CRYSTAL;
            default:
                return false;
        }
    }
