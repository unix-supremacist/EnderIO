...
public class HUDTickHandler {
    ...
    private static void tickEnd() {
        if (mc.thePlayer != null) {
            if ((mc.currentScreen == null || Config.showHUDWhileChatting && mc.currentScreen instanceof GuiChat)
                ...
                if (chestplate != null && chestplate.getItem() instanceof IHUDInfoProvider) {
                    ...
                    int i = 0;
                    for (String s : info) {
                        RenderUtils.drawStringAtHUDPosition(
                                s,
                                HUDPositions.values()[Config.HUDPosition],
                                mc.fontRenderer,
                                Config.HUDOffsetX,
                                Config.HUDOffsetY,
                                Config.HUDScale,
