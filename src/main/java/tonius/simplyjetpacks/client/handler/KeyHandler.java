...
public class KeyHandler {
    ...
    public static final SJKeyBinding keyTogglePrimary =
            new SJKeyBinding("toggle.primary", Keyboard.KEY_F, ModKey.TOGGLE_PRIMARY);
    public static final SJKeyBinding keyToggleSecondary =
            new SJKeyBinding("toggle.secondary", Keyboard.KEY_NONE, ModKey.TOGGLE_SECONDARY);
    public static final SJKeyBinding keyModePrimary =
            new SJKeyBinding("mode.primary", Keyboard.KEY_C, ModKey.MODE_PRIMARY);
    public static final SJKeyBinding keyModeSecondary =
            new SJKeyBinding("mode.secondary", Keyboard.KEY_NONE, ModKey.MODE_SECONDARY);
    public static final SJKeyBinding keyOpenPackGUI =
    ...
    private static void tickStart() {
        if (mc.thePlayer != null) {
            ...
            if (flyState != lastFlyState
                ...
                PacketHandler.instance.sendToServer(new MessageKeyboardSync(
                        flyState, descendState, forwardState, backwardState, leftState, rightState));
                SyncHandler.processKeyUpdate(
