...
public class ClientTickHandler {
    ...
    private static void tickEnd() {
        ...
        if (!mc.isGamePaused()) {
            ...
            while (itr.hasNext()) {
                ...
                if (entity == null
                        ...
                        || entity.dimension != mc.thePlayer.dimension) {
                    itr.remove();
                } else {
                    ...
                    if (particle != null) {
                        ...
                        if (Config.jetpackSounds && !SoundJetpack.isPlayingFor(entity.getEntityId())) {
                            Minecraft.getMinecraft().getSoundHandler().playSound(new SoundJetpack((EntityLivingBase)
                                    entity));
                        }
                    } else {
                        itr.remove();
        ...
        if (!Config.doubleTapSprintInAir
                || !wearingJetpack
