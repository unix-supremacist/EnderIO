...
public class CommonProxy {
    ...
    public void registerHandlers() {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(EnderIO.instance, new GuiHandler());
    ...
    public void throwCoFHLibException() {
        throw new RuntimeException(
                "CoFHLib is not installed or not up to date. Please install CoFH Core 3.0.2 or newer, or CoFHLib standalone 1.0.2 or newer.");
    }
}
