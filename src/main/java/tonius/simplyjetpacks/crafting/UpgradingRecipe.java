    ...
    public ItemStack getCraftingResult(InventoryCrafting inventoryCrafting) {
        ...
        for (int i = 0; i < inventoryCrafting.getSizeInventory(); i++) {
            ...
            if (slotStack != null && slotStack.getItem() != null) {
                ...
                } else if (ModItems.enderiumUpgrade != null
                        && slotStack.getItem() == ModItems.enderiumUpgrade.getItem()
                        && slotStack.getItemDamage() == ModItems.enderiumUpgrade.getItemDamage()) {
        ...
        NBTHelper.getNBT(result)
                .setInteger("Energy", Math.min(addedEnergy, this.resultItem.getMaxEnergyStored(result)));
